...
function stream({ d: dumpVersion, p: progress = false }) {
    return __awaiter(this, void 0, void 0, function* () {
        const version = dumpVersion || (yield getLatestVersion());
        ...
        const elasticStream = new ElasticWriteStream("master");
        yield elasticStream.initializeClient("http://localhost:9200");
