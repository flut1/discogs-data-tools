...
export const videoTransformer = createXMLTransformer({
    ...
    const result = withRequiredProperties({ title, description, src: attributes.src }, "src");
...
export const videosTransformer = createListTransformer("video", videoTransformer);
